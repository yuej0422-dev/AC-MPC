...
output="$project_root/runs/manisoft_waypoint_arch_long10to20_transfer_v1_20260824"
...
# One simulator process per physical CPU core.  Keep BLAS single-threaded so
# the 16 workers do not oversubscribe the host; SAC's large batches and eight
# gradient steps run on the RTX 4090.
