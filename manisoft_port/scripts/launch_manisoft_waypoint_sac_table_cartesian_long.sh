...
pilot_root="$project_root/runs/manisoft_waypoint_sac_table_cartesian_pilot_v3_20260822"
run_root="$project_root/runs/manisoft_waypoint_sac_table_cartesian_long_20260822"
mkdir -p "$run_root"
...
launch() {
  ...
  nohup setsid env \
    ...
    "$python_bin" -u scripts/train_manisoft_waypoint_sac.py \
      ...
      --resume "$source/final_model.zip" \
      --vec-normalize "$source/vecnormalize.pkl" \
      --total-timesteps 4000000 --num-envs 40 \
      --checkpoint-freq 100000 --eval-freq 100000 --eval-episodes 24 \
...
cd "$project_root"
launch d_fixed_large 0.00010 8192 1010442
launch c_fast_auto 0.00020 2048 1000442
launch main_auto 0.00010 2048 1020442
launch b_low_entropy 0.00005 2048 1030442
