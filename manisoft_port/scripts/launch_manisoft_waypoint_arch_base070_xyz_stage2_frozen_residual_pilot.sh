...
output="$project_root/runs/manisoft_waypoint_arch_base070_xyz_stage2_frozen_residual_pilot_v1_20260824"
...
exec "$python_bin" -u scripts/train_manisoft_waypoint_sac.py \
  ...
  --residual-action-scale 0.020 \
  --residual-action-penalty-scale 0.20 \
  --zero-init-actor \
