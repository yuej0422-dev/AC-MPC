...
run_root="$project_root/runs/manisoft_waypoint_sac_entry_scale_pilot_20260822"
...
launch() {
  ...
  local pid=$!
  echo "$pid" >"$pid_file"
  echo "$name PID=$pid lr=$learning_rate batch=$batch_size envs=16 gradients=2"
}

cd "$project_root"
launch main_stable 0.00001 1024 220442
launch b_conservative 0.000005 1024 230442
launch c_wide_batch 0.00001 2048 240442
launch d_slow_wide 0.000005 2048 250442
